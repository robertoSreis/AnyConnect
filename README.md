...
Compile: python -m nuitka --standalone --enable-plugin=pyqt6 --include-data-dir=* --pgo-python --windows-icon-from-ico=marca-preta.ico --output-dir=dist --output-filename=SE3D.exe --company-name="SE3D" --product-name="SE3D GESTÃO" --clang --lto=yes --file-version=1.0.5.373 --windows-console-mode=disable main.py
